...
dataset = dataset + np.random.normal(0,0.0001,(len(dataset),dim_select)) # add tiny gaussian noise to data to avoid points with the same x coordinate (bad for x-axis slices)
...
print('Done!')
print(f'Algorithm Runtime: {int((stop - start))} seconds\n')
