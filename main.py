...
dataset_select = 4  # change dataset selection here
...
if dataset_select == 0:
    ...
    # covid dataset
    dataset = pd.read_csv('covid.csv')[['longitude', 'latitude']]
    dataset = dataset.dropna()  # drop nan data
...
convex_hull = ch2d.convex_hull(points)  # create convex hull
ch2d.plot_convex_hull(points,convex_hull)  # plot points and convex hull of the points
